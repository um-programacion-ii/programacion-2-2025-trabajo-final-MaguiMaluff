...
import ar.edu.um.repository.EventoRepository;
import ar.edu.um.service.dto.EventoDTO;
import ar.edu.um.service.mapper.EventoMapper;
...
/**
 * Service Implementation for managing {@link ar.edu.um.domain.Evento}.
 */
@Service
@Transactional
