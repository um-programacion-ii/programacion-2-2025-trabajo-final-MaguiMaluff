...
import static ar.edu.um.domain.VentaAsserts.*;
import static ar.edu.um.web.rest.TestUtil.createUpdateProxyForBean;
import static ar.edu.um.web.rest.TestUtil.sameNumber;
...
import ar.edu.um.repository.VentaRepository;
import ar.edu.um.service.dto.VentaDTO;
import ar.edu.um.service.mapper.VentaMapper;
...
class VentaResourceIT {
    ...
    private static final Integer DEFAULT_CANTIDAD_ASIENTOS = 0;
    private static final Integer UPDATED_CANTIDAD_ASIENTOS = 1;
    ...
    void partialUpdateVentaWithPatch() throws Exception {
        ...
        partialUpdatedVenta.resultado(UPDATED_RESULTADO).cantidadAsientos(UPDATED_CANTIDAD_ASIENTOS);
